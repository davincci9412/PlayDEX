...
const Farms: React.FC = () => {
  ...
  const rowData = chosenFarmsMemoized.filter(item =>item.pid!==2 && item.pid!==1).map((farm) => {
  ...
  return (
    <>
      <PageHeader background="linear-gradient(139.73deg,#040404 0%,#312d35 100%);">
        <Heading as="h1" scale="xxl" color="#ffd600" mb="24px">
          {t('Farms')}
        </Heading>
