...
export const CAKE: { [chainId: number]: Token } = {
  [ChainId.MAINNET]: new Token(
    ChainId.MAINNET,
    '0x543E2B20430A05A21043521314634f1759110fc3',
    18,
    'PLAYX',
    'PLAYDEX',
  ),
  [ChainId.TESTNET]: new Token(
    ChainId.TESTNET,
    '0x281D220DDD105A18F53E2E50932c8796D50Fd357',
    18,
    'PLAYX',
    'PLAYDEX',
  ),
...
export const BUSD: { [chainId: number]: Token } = {
  ...
  [ChainId.TESTNET]: new Token(
    ChainId.TESTNET,
    '0xE79ACF0892Df9503083C836d93693a888D9fFEeb',
    18,
    'BUSD',
    'Binance USD',
  ),
...
// export const WBNB = new Token(ChainId.TESTNET, '0x63a543a3F0a9ce6665557983C6FbC0A9f38adB2F', 18, 'WBNB', 'Wrapped BNB')
...
export const WBNB: { [chainId: number]: Token } = {
  ...
  [ChainId.TESTNET]: new Token(
    ChainId.TESTNET,
    '0x63a543a3F0a9ce6665557983C6FbC0A9f38adB2F',
    18,
    'WBNB',
    'Wrapped BNB',
  ),
...
export const ETH: { [chainId: number]: Token } = {
  ...
  [ChainId.TESTNET]: new Token(
    ChainId.TESTNET,
    '0x8F6A90EB9cAF8C65a9e352447cE46d1E6AEBA1CA',
    18,
    'ETH',
    'Ethereum Token',
  ),
...
export const USDT: { [chainId: number]: Token } = {
  ...
  [ChainId.TESTNET]: new Token(
    ChainId.TESTNET,
    '0x1b061D23D8d0337eC60F01F789517a75fF8e3de0',
    18,
    'USDT',
    'Tether USD',
  ),
...
export const BTCB: { [chainId: number]: Token } = {
  ...
  [ChainId.TESTNET]: new Token(
    ChainId.TESTNET,
    '0x9C5796A5594dFf949530d291fF87C9c1b0A34140',
    18,
    'BTCB',
    'BTCB Token',
  ),
...
const tokens = {
  ...
  cake: {
    symbol: 'PLAYX',
    address: {
      56: '0x543E2B20430A05A21043521314634f1759110fc3',
      97: '0x281D220DDD105A18F53E2E50932c8796D50Fd357',
    },
    decimals: 18,
  ...
  syrup: {
    symbol: 'SYRUP',
    address: {
      56: '0x0F8876A893319c0e4e25De8d822578d647bba931',
      97: '0x45a1E4EDDd2d81c3cA946Ac19193Ae0AA393C429',
    },
    decimals: 18,
    projectLink: 'https://pancakeswap.finance/',
  },
  wbnb: {
    ...
    address: {
      ...
      97: '0x63a543a3F0a9ce6665557983C6FbC0A9f38adB2F',
    },
    decimals: 18,
    projectLink: 'https://pancakeswap.finance/',
  },
  usdt: {
    ...
    address: {
      ...
      97: '0x1b061D23D8d0337eC60F01F789517a75fF8e3de0',
    },
    decimals: 18,
  ...
  eth: {
    ...
    address: {
      ...
      97: '0x8F6A90EB9cAF8C65a9e352447cE46d1E6AEBA1CA',
    },
    decimals: 18,
  ...
  btcb: {
    ...
    address: {
      ...
      97: '0x9C5796A5594dFf949530d291fF87C9c1b0A34140',
    },
    decimals: 18,
  ...
  busd: {
    ...
    address: {
      ...
      97: '0xE79ACF0892Df9503083C836d93693a888D9fFEeb',
    },
    decimals: 18,
